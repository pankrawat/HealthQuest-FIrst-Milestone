...
public class OauthUtils {
    ...
    public static Uri.Builder setOauthParameters(String clientId, String callbackUrl, List<Constants.JawboneAuthScope> scope) {
    ...
    public static Uri.Builder setOauthScopeParameters(List<Constants.JawboneAuthScope> scopeArrayList, Uri.Builder builder) {
        StringBuilder scopeValues = new StringBuilder();

        for (Constants.JawboneAuthScope scope : scopeArrayList) {
            switch (scope) {
                case BASIC_READ:
