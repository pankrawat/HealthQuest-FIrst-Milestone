...
import com.tupelo.wellness.imagecropper.CropImage;
...
public class TakeImageClass {
	...
	public static final String TEMP_PHOTO_FILE_NAME="profile_pic.jpg";
	...
	{
		Log.e("in on activity result of take image class", "requestCode=>>>>>" + requestCode);
		...
		case REQUEST_CODE_TAKE_PICTURE:
			Log.e(" REQUEST_CODE_TAKE_PICTURE", "REQUEST_CODE_TAKE_PICTURE");
	...
	public void getImagePickerDialog(final Activity ctx,final String title,final String message) {
		...
		AlertDialog.Builder alertBuild=null;
		if(currentVersion>android.os.Build.VERSION_CODES.HONEYCOMB)
			alertBuild= new AlertDialog.Builder(ctx, AlertDialog.THEME_HOLO_LIGHT);
		else
			alertBuild= new AlertDialog.Builder(ctx);
	...
	/*
	public  Dialog getImagePickerDialog(final Activity mContext,final int requestCode) 
	{
