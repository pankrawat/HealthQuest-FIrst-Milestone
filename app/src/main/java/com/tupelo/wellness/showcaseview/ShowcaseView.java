...
package com.tupelo.wellness.showcaseview;
...
import com.tupelo.wellness.showcaseview.targets.Target;

import static com.tupelo.wellness.showcaseview.AnimationFactory.AnimationEndListener;
import static com.tupelo.wellness.showcaseview.AnimationFactory.AnimationStartListener;
...
public class ShowcaseView extends RelativeLayout implements View.OnTouchListener, ShowcaseViewApi {
    ...
    protected ShowcaseView(Context context, AttributeSet attrs, int defStyle, boolean newStyle) {
        ...
        mEndButton = (Button) LayoutInflater.from(context).inflate(R
                .layout.showcase_button, null);
        if (newStyle) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (!hasNoTarget) {
            showcaseDrawer.drawShowcase(bitmapBuffer, viewRect.left, viewRect.top, viewRect.right, viewRect.bottom, scaleMultiplier);
    ...
    public static class Builder {
         ...
         *
         * @param target a {@link Target} representing
    ...
    /**
     * @see Builder#setSingleShot(long)
     */
    ...
    /**
     * @see Builder#hideOnTouchOutside()
     */
    @Override
