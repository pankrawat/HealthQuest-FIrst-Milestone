...
class NewShowcaseDrawer extends StandardShowcaseDrawer {
    ...
    @Override
    public void drawShowcase(Bitmap buffer, int x, int y, int w, int h, float scaleMultiplier) {
        Canvas bufferCanvas = new Canvas(buffer);


     //   bufferCanvas.drawRect(2 * outerRadius, 2 * outerRadius, 2 * outerRadius, 2 * outerRadius, eraserPaint);
//        bufferCanvas.drawCircle(x, y, outerRadius, eraserPaint);
     //bufferCanvas.drawCircle(x, y, outerRadius, eraserPaint);
        ...
        bufferCanvas.drawRect(x + 15, y + 15, x + w - 15, y + h - 15, eraserPaint);
        ...
        bufferCanvas.drawRect(x, y, x + w, y + h, eraserPaint);

///////////////////////
//
//        bufferCanvas.drawRect(left-120, top-100,
//                left,
//                top, eraserPaint);
//
