...
public class RaleTextView extends TextView {

    private Typeface typefaceMedium, typefaceRegular, typefaceBold, typefaceLite;

    public RaleTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        loadTypeFace(context);
        init(attrs);
    }

    public RaleTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        loadTypeFace(context);
        init(attrs);
    }

    public RaleTextView(Context context) {
        super(context);
        loadTypeFace(context);
        init(null);
    }
...
//        }
    ...
    public void loadTypeFace(Context mContext) {
        ...
        if (typefaceRegular == null)
            typefaceRegular = Typeface.createFromAsset(mContext.getAssets(), "fonts/Raleway-Regular.ttf");
        if (typefaceLite == null)
            typefaceLite = Typeface.createFromAsset(mContext.getAssets(), "fonts/Raleway-Light.ttf");
    }
}
